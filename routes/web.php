...
Route::get('/google-test', function (Request $request) {
    ...
    $query = 'SELECT campaign.id, campaign.name, campaign.optimization_score, metrics.impressions, metrics.clicks FROM campaign WHERE segments.date = "2024-04-05" ORDER BY campaign.id';
