<!--begin::Modal - Connect Slanje Paketa-->
<div class="modal fade" id="connectSlanjePaketaModal" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-header align-self-center">
                ...
                <h2 class="text-center m-0 d-flex align-items-center">
                    <span>Poveži nalog (Slanje Paketa)</span>
                </h2>
                <!--end::Modal title-->
            </div>
            <!--end::Modal header-->
            ...
            <form class="form" action="{{ route('companies.update.keys') }}" method="POST">
                ...
                <input type="hidden" name="provider" value="slanje_paketa">
...
<!--end::Modal - Connect Slanje Paketa-->
