<x-app-layout>
    ...
    <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" data-kt-daterangepicker-range="today" class="btn btn-sm btn-light-success d-flex align-items-center justify-content-center px-4 w-250px">
        <!--begin::Display range-->
